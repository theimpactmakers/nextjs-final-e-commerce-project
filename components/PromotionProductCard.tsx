        ...
        <div
          className={`absolute top-2.5 right-2.5 z-10 ${
            promotion.discount_value === 10
              ? "bg-muted-foreground"
              : "bg-linear-to-r from-[#a90329] via-[#c44848] to-[#aa2238]"
          } text-white px-2.5 py-1.5 text-[13px] font-semibold uppercase tracking-wider rounded-full shadow-[0_3px_10px_rgba(0,0,0,0.2)]`}
        >
