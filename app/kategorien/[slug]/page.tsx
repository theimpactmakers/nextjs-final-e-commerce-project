...
const categoryNames: Record<string, string> = {
  welpen: "Welpenfutter",
  erwachsen: "Adult Futter",
  senior: "Senior Futter",
  trockenfutter: "Trockenfutter",
  nassfutter: "Nassfutter",
  snacks: "Snacks & Leckerlis",
};
...
export default async function KategorieDetailPage({
  ...
  // Hier würde man normalerweise nach Kategorie filtern
  // Für jetzt zeigen wir alle Produkte
  ...
  return (
    <div className="container max-w-7xl px-4 py-8">
      ...
      <div className="mb-6 text-sm text-muted-foreground">
        ...
        {" / "}
        <Link href="/kategorien" className="hover:text-foreground">
          Kategorien
        </Link>
        {" / "}
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Entdecke unsere {categoryName.toLowerCase()}-Produkte
        </p>
      </div>
